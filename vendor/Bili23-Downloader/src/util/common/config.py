...
portable_data_path = os.environ.get("OFFLINE_BILI_BILI23_DATA")
if portable_data_path:
    appdata_path = str(Path(portable_data_path).resolve())
    config_path = Path(appdata_path) / "config.json"
